...
export default function Header({ setIsCartOpen, toggleMobileMenu }) {
  ...
  return (
    /* sticky top-0 ensures the header is fixed at the top for both mobile and web */
    <header className="sticky top-0 z-[100] bg-[#F9F7F2]/95 backdrop-blur-sm border-b border-stone-200 pt-4 pb-3 px-4 md:px-10">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between">
          
          {/* 1. Three Bar Icon (Left on mobile, hidden on desktop) */}
          <button 
          ...
          {/* 2. Boxed Logo (Centered on mobile, left-aligned on desktop) */}
          <div 
