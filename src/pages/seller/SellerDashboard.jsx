    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between sticky top-0 z-30">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-base font-bold text-gray-800">
              {NAV.find(n => n.path === location.pathname)?.label || 'Seller Center'}
            </h1>
          </div>
        ...
        <main className="flex-1 p-6">
              ...
              {isApproved && (
                <div className="bg-white border border-gray-100 rounded-lg p-5 shadow-sm mb-8">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    {[
                      { label: 'Add Product',    path: '/seller/products', icon: '➕' },
          ...
          {location.pathname === '/seller/products' && (
            isApproved ? (
              ...
              <div className="bg-white border border-gray-100 rounded-lg p-12 text-center shadow-sm">
                ...
                <p className="text-gray-500 font-medium mb-1">Account Not Approved Yet</p>
                <p className="text-gray-400 text-sm">
                  You can list products once your account is approved by admin.
                </p>
              </div>
            )
          )}
          ...
          {/* ── 4. MY STORE (/seller/store) ──────────────────────────────── */}
          {location.pathname === '/seller/store' && (
            <div className="bg-white border border-gray-100 rounded-lg p-6 shadow-sm">
              <h2 className="text-base font-bold text-gray-800 mb-1">Store Settings</h2>
              <p className="text-sm text-gray-400 mb-6">
                Update your public store profile. This is what customers see.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  { label: 'Company Name', value: seller?.company_name },
                  { label: 'District',     value: seller?.district },
              ...
              <p className="text-xs text-gray-400 mt-6 italic">
                Full store editing coming soon. For now, update via the seller registration info.
              </p>
            </div>
          )}
